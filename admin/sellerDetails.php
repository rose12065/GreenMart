<?php
    ...
    $sql_seller="SELECT * FROM tbl_seller_register ORDER BY status ASC";
    $all_seller = $conn->query($sql_seller);
...
<div class="ms-3">
  <p class="fw-bold mb-1"><?php echo $sellerId; ?></p>
</div>
</div>
        </td>
      <td>
        <div class="d-flex align-items-center">
          ...
          <div class="ms-3">
            <p class="fw-bold mb-1"><?php echo $sellerName; ?></p>
          </div>
        </div>
      </td>
      <td>
        <p class="fw-normal mb-1"><?php echo $sellerMobile; ?></p>
      </td>
    ...
    if ($status == 0) {
        ...
        <a href="approveSeller.php ? seller_id=<?php echo $sellerId ?>" > <span class="badge badge-danger rounded-pill d-inline"> Approve</span></a>
        </button>
         <button type="button" class="btn btn-link btn-sm px-3" data-ripple-color="dark">
        <a href="rejectSeller.php ? seller_id=<?php echo $sellerId ?>" > <span class="badge badge-danger rounded-pill d-inline"> Reject</span></a>
        </button>
   <?php }
    elseif($status == 1){
        ?><button type="button" class="btn btn-link btn-sm px-3" data-ripple-color="dark">
