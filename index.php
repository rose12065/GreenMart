...
<html lang="en">
  <head>
    <title>GreenMart | Healthy Choice</title>
    <meta charset="utf-8">
    ...
    <header>
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-6 offset-sm-3 offset-md-0 col-lg-7 d-none d-lg-block">
            <div class="container-fluid">
              <div class="row py-3">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim massa diam elementum.</p>
                          <a href="/login-url" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">shop collection</a>
                        </div>
                        <div class="img-wrapper col-md-5">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/aashirvaad_logo.png" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Aashirvaad</p>
                          <h5 class="card-title">AASHIRVAAD Nature's Superfoods</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/eastern_logo.png" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Eastern</p>
                          <h5 class="card-title">India's No.1 spice company</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/doublehorse_logo.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Double Horse</p>
                          <h5 class="card-title">60 years of inspiring cooking</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images\pavizham_logo.png" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Pavizham</p>
                          <h5 class="card-title">Largest Rice Exporter in Kerala </h5>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <footer class="py-5">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-sm-3 col-am-3 col-sm-3">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">selling products</a>
                </li>
                <li class="menu-item">
